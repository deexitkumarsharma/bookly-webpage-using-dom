...
body.style.background = "rgb(245, 222, 179)";
...
heading.style.background = "rgb(66, 130, 127)";
...
mainContainer.style.background = "#FFF5E8";
...
for (let index = 0; index < 8; index++) {
  ...
  // title
  let titleEle = document.createElement("titleEle");
  titleEle.innerText = data.books[index].title;
  titleEle.style.fontSize = "20px";
  titleEle.style.fontWeight = "bold";
  titleEle.style.marginTop = "15px";
  card.appendChild(titleEle);

  // author
  let authorele = document.createElement("authorele");
  authorele.innerText = "Author: " + data.books[index].author;
  authorele.style.fontSize = "15px";
  authorele.style.marginTop = "10px";
